...
Administrator@DESKTOP-AV2PARO MINGW64 ~/Desktop/Sanrojo_IT120_Activity1 (Sanrojo_B4)
$ git add Readme.txt
...
Administrator@DESKTOP-AV2PARO MINGW64 ~/Desktop/Sanrojo_IT120_Activity1 (Sanrojo_B4)
$ git commit -m "Amend data and removed Test.py"
[Sanrojo_B4 7ce28a1] Amend: updated Readme.txt and removed Test.py
 2 files changed, 148 insertions(+), 3 deletions(-)
 delete mode 100644 Test.py

Administrator@DESKTOP-AV2PARO MINGW64 ~/Desktop/Sanrojo_IT120_Activity1 (Sanrojo_B4)
$ git push origin Sanrojo_B4
Enumerating objects: 5, done.
Counting objects: 100% (5/5), done.
Delta compression using up to 4 threads
Compressing objects: 100% (3/3), done.
...
remote: Resolving deltas: 100% (1/1), completed with 1 local object.
remote:
remote: Create a pull request for 'Sanrojo_B4' on GitHub by visiting:
remote:      https://github.com/louie20041217/Sanrojo_IT120_Activity1/pull/new/Sanrojo_
B4
remote:
To https://github.com/louie20041217/Sanrojo_IT120_Activity1.git
 * [new branch]      Sanrojo_B4 -> Sanrojo_B4
...
* Sanrojo_B4
  master
  remotes/origin/Sanrojo_B1
  remotes/origin/Sanrojo_B2
  remotes/origin/Sanrojo_B3
  remotes/origin/Sanrojo_B4
